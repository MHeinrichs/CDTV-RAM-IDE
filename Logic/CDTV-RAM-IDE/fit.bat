...
cpldfit.exe -intstyle ise -p xc95144xl-10-TQ144 -ofmt vhdl -htmlrpt -optimize density -loc on -slew fast -init low -inputs 54 -pterms 25 -unused float -power std -terminate float RAM_IDE_AUTOCONFIG.ngd >log.txt 
